...
-- -----------------------------------------------------
-- procedure add_result_from_job
-- -----------------------------------------------------

USE `AUTOMATION`;
DROP procedure IF EXISTS `AUTOMATION`.`add_result_from_job`;

DELIMITER $$
USE `AUTOMATION`$$
CREATE DEFINER=`dummy`@`%` PROCEDURE `add_result_from_job`(job_id int(11),testresult varchar(128))
BEGIN
...
USE `AUTOMATION`;
DROP procedure IF EXISTS `AUTOMATION`.`add_machine`;
...
-- -----------------------------------------------------
-- procedure get_platform_id_by_name
-- -----------------------------------------------------

USE `AUTOMATION`;
DROP procedure IF EXISTS `AUTOMATION`.`get_platform_id_by_name`;
